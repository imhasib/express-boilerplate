...
describe('User routes', () => {
  describe('POST /v1/users', () => {
    ...
    test('should return 201 and successfully create new user if data is ok', async () => {
      ...
      expect(dbUser).toMatchObject({ name: newUser.name, email: newUser.email, role: newUser.role, mobile: newUser.mobile, isEmailVerified: false });
    });
  ...
  describe('PATCH /v1/users/:userId', () => {
    test('should return 200 and successfully update user if data is ok', async () => {
      ...
      expect(dbUser).toMatchObject({ name: updateBody.name, email: updateBody.email, role: 'user', mobile: userOne.mobile });
    });
